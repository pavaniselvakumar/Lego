 ...
 * Wed Apr 17 2024 20:42:25 GMT+0530 (India Standard Time)
...
var dictred, clonedpink, clonedblue, dictblue;
...
function drag1() {
  registerOnDrag(dictred, false, [0,1,2], function() {}, function() {
    dragMove(dictred, 'XYZ', 'sY$J~gh7kWMtxynpPj9Y', 'Aui3jE.{cwt.hrhj+2Ba');
  }, function() {}, 'Aui3jE.{cwt.hrhj+2Ba');
  objConstraintAddLimit('myConst1', dictred, 'POS_Z', 1.70602, 12, '', 0, 'LIMITDIST_ONSURFACE');
}

// Describe this function...
function drag2() {
  registerOnDrag(clonedpink, false, [0,1,2], function() {}, function() {
    dragMove(clonedpink, 'XYZ', 'a9FBGQZ^f3HEI{fOwz`L', 'zx9mbl:vF`6nDf=vJg5l');
  }, function() {}, 'zx9mbl:vF`6nDf=vJg5l');
  objConstraintAddLimit('myConst2', clonedpink, 'POS_Z', 1.70602, 12, '', 0, 'LIMITDIST_ONSURFACE');
}

// Describe this function...
function drag3() {
  registerOnDrag(clonedblue, false, [0,1,2], function() {}, function() {
    dragMove(clonedblue, 'XYZ', 'R6jT1SIFv/S^p8yNZbG1', 'I`2TETtU7g]*2HSmaeDi');
  }, function() {}, 'I`2TETtU7g]*2HSmaeDi');
  objConstraintAddLimit('myConst3', clonedblue, 'POS_Z', 1.70602, 12, '', 0, 'LIMITDIST_ONSURFACE');
}
...
changeVis('Cylinder.001', false);
changeVis('Cylinder.004', false);
...
addHTMLElement('button', 'Pink', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('position', 'static', 'Pink', false);
setHTMLElemStyle('backgroundColor', 'pink', 'Pink', false);
setHTMLElemStyle('height', '60px', 'Pink', false);
setHTMLElemStyle('width', '60px', 'Pink', false);
eventHTMLElem('click', 'Pink', false, function(event) {
  changeVis('Cylinder.004', true);
});
...
registerOnDrag('Cylinder.001', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.001', 'XYZ', 'S6+Y32EEItRw)p8Ho)1|', '=o;](W7Gdh|]4CH+s)wY');
}, function() {}, '=o;](W7Gdh|]4CH+s)wY');
registerOnDrag('Cylinder.004', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.004', 'XYZ', 'K|G1r=nqX:C15HOTj2*R', '%_*KwR]ftoOCZv}2`Hrb');
}, function() {}, '%_*KwR]ftoOCZv}2`Hrb');
registerOnDrag('Cylinder', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder', 'XYZ', 'FqTX_+?In7syzE*TvQB~', '%e;Vo1hkzsz{p6DHZ%%3');
}, function() {}, '%e;Vo1hkzsz{p6DHZ%%3');
handleAnnot(true, 'help', 'Plane', 'A User can only use the blocks with thesame color' + 'Can select block', 'poi1', undefined);
eventHTMLElem('dblclick', 'Red', false, function(event) {
  dictred = cloneObject('Cylinder.001');
  changeVis(dictred, true);
  drag1();
});

eventHTMLElem('dblclick', 'Pink', false, function(event) {
  clonedpink = cloneObject('Cylinder.004');
  changeVis(clonedpink, true);
  drag2();
});

eventHTMLElem('dblclick', 'Blue', false, function(event) {
  clonedblue = cloneObject('Cylinder');
  changeVis(clonedblue, true);
  drag3();
});

dictred = {};
dictSet(dictred, 'x1', getObjTransform(dictred, false, 'position', 'x'));
dictSet(dictred, 'y1', getObjTransform(dictred, false, 'position', 'y'));
dictSet(dictred, 'z1', getObjTransform(dictred, false, 'position', 'z'));
dictblue = {};
dictSet(dictblue, 'x2', getObjTransform(dictblue, false, 'position', 'x'));
dictSet(dictblue, 'y2', getObjTransform(dictblue, false, 'position', 'y'));
dictSet(dictblue, 'z2', getObjTransform(dictblue, false, 'position', 'z'));
dictblue = {};
dictSet(dictblue, 'x3', getObjTransform(dictblue, false, 'position', 'x'));
dictSet(dictblue, 'y3', getObjTransform(dictblue, false, 'position', 'y'));
dictSet(dictblue, 'z3', getObjTransform(dictblue, false, 'position', 'z'));

addHTMLElement('button', 'button 1', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('position', 'absolute', 'button1', false);
setHTMLElemStyle('bottom', '100px', 'button1', false);
setHTMLElemStyle('right', '5%', 'button1', false);
setHTMLElemStyle('backgroundColor', 'white', 'button1', false);
setHTMLElemStyle('height', '45px', 'button1', false);
setHTMLElemStyle('width', '60px', 'button1', false);
setHTMLElemAttribute('innerHTML', 'Save', 'button1', false);

addHTMLElement('button', 'button2', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('position', 'absolute', 'button2', false);
setHTMLElemStyle('bottom', '100px', 'button2', false);
setHTMLElemStyle('right', '0%', 'button2', false);
setHTMLElemStyle('backgroundColor', 'orange', 'button2', false);
setHTMLElemStyle('height', '45px', 'button2', false);
setHTMLElemStyle('width', '60px', 'button2', false);
setHTMLElemAttribute('innerHTML', 'Load', 'button2', false);

eventHTMLElem('click', 'button1', false, function(event) {});
