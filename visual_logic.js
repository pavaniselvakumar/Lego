 ...
 * Thu Apr 11 2024 15:07:44 GMT+0530 (India Standard Time)
...
var clonedred, clonedpink, clonedblue;
...
function drag1() {
  registerOnDrag(clonedred, false, [0,1,2], function() {}, function() {
    dragMove(clonedred, 'XYZ', 'sY$J~gh7kWMtxynpPj9Y', 'Aui3jE.{cwt.hrhj+2Ba');
...
eventHTMLElem('dblclick', 'Red', false, function(event) {
  clonedred = cloneObject('Cylinder.001');
